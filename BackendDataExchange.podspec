#
#  Be sure to run `pod spec lint BackendDataExchange.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "peteryxu" => "peteryxu2012@gmail.com" }
  # Or just: s.author    = "peteryxu"
  # s.authors            = { "peteryxu" => "peteryxu2012@gmail.com" }
  # s.social_media_url   = "http://twitter.com/peteryxu"
  ...
  s.source       = { :git => "https://github.com/peteryxu/BackendDataExchange.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "BackendDataExchange/**/*.{swift}"
